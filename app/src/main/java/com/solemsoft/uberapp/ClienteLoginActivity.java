    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(ClienteLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            Toast.makeText(ClienteLoginActivity.this, "Error al ingresar", Toast.LENGTH_SHORT).show();
                        } else {
        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String email = mEmail.getText().toString();
                final String password = mPassword.getText().toString();
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(ClienteLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            Toast.makeText(ClienteLoginActivity.this, "Error al ingresar", Toast.LENGTH_SHORT).show();
